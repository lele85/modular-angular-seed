module.exports = function(grunt) {
	...
	grunt.registerTask("serve", "Serve client application and any mock service defined in /scripts/server/app.js. Invoked with --minified builds and serve the minified version of the frontend.", minificationTasks.concat(["shell:serve"]));
